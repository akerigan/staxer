...
public class JsonUtils {
    ...
    public static JsonObjectMap deserializeMapJson(String s) throws JsonException {
        JsonObject jsonObject = deserializeJson(s);
    ...
    public static JsonObjectList deserializeListJson(String s) throws JsonException {
        JsonObject jsonObject = deserializeJson(s);
