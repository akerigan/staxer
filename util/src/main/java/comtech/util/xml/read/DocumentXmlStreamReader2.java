 ...
 * Time: 13:10:01
 */
public class DocumentXmlStreamReader2 {
    ...
    public DocumentXmlStreamReader2(InputStream stream) throws XMLStreamException {
        this.reader = factory.createXMLStreamReader(stream, "utf-8");
    }

    public DocumentXmlStreamReader2(Reader reader) throws XMLStreamException {
        this.reader = factory.createXMLStreamReader(reader);
    }

    public DocumentXmlStreamReader2(XMLStreamReader xmlStreamReader) {
