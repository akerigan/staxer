...
public class XsdTypes implements StaxerReadXml, StaxerWriteXml {
    ...
    public static final XmlName XML_NAME_ELEM_STRING = new XmlName("http://sample.staxer.org/", "elemString");
    public static final XmlName XML_NAME_ELEM_INTEGER = new XmlName("http://sample.staxer.org/", "elemInteger");
    public static final XmlName XML_NAME_ELEM_CHARACTER = new XmlName("http://sample.staxer.org/", "elemCharacter");
    public static final XmlName XML_NAME_ELEM_FLOAT = new XmlName("http://sample.staxer.org/", "elemFloat");
    public static final XmlName XML_NAME_ELEM_DOUBLE = new XmlName("http://sample.staxer.org/", "elemDouble");
    public static final XmlName XML_NAME_ELEM_DECIMAL = new XmlName("http://sample.staxer.org/", "elemDecimal");
    public static final XmlName XML_NAME_ELEM_DATE_TIME = new XmlName("http://sample.staxer.org/", "elemDateTime");
    public static final XmlName XML_NAME_ELEM_BOOLEAN = new XmlName("http://sample.staxer.org/", "elemBoolean");
    public static final XmlName XML_NAME_ELEM_BASE64_BINARY = new XmlName("http://sample.staxer.org/", "elemBase64Binary");
    public static final XmlName XML_NAME_LST_STRING = new XmlName("http://sample.staxer.org/", "lstString");
    public static final XmlName XML_NAME_LST_INTEGER = new XmlName("http://sample.staxer.org/", "lstInteger");
    public static final XmlName XML_NAME_LST_CHARACTER = new XmlName("http://sample.staxer.org/", "lstCharacter");
    public static final XmlName XML_NAME_LST_FLOAT = new XmlName("http://sample.staxer.org/", "lstFloat");
    public static final XmlName XML_NAME_LST_DOUBLE = new XmlName("http://sample.staxer.org/", "lstDouble");
    public static final XmlName XML_NAME_LST_DECIMAL = new XmlName("http://sample.staxer.org/", "lstDecimal");
    public static final XmlName XML_NAME_LST_DATE_TIME = new XmlName("http://sample.staxer.org/", "lstDateTime");
    public static final XmlName XML_NAME_LST_BOOLEAN = new XmlName("http://sample.staxer.org/", "lstBoolean");
    public static final XmlName XML_NAME_LST_BASE64_BINARY = new XmlName("http://sample.staxer.org/", "lstBase64Binary");
    public static final XmlName XML_NAME_ATT_STRING = new XmlName("http://sample.staxer.org/", "attString");
    public static final XmlName XML_NAME_ATT_INTEGER = new XmlName("http://sample.staxer.org/", "attInteger");
    public static final XmlName XML_NAME_ATT_CHARACTER = new XmlName("http://sample.staxer.org/", "attCharacter");
    public static final XmlName XML_NAME_ATT_FLOAT = new XmlName("http://sample.staxer.org/", "attFloat");
    public static final XmlName XML_NAME_ATT_DOUBLE = new XmlName("http://sample.staxer.org/", "attDouble");
    public static final XmlName XML_NAME_ATT_DECIMAL = new XmlName("http://sample.staxer.org/", "attDecimal");
    public static final XmlName XML_NAME_ATT_DATE_TIME = new XmlName("http://sample.staxer.org/", "attDateTime");
    public static final XmlName XML_NAME_ATT_BOOLEAN = new XmlName("http://sample.staxer.org/", "attBoolean");
    public static final XmlName XML_NAME_ATT_BASE64_BINARY = new XmlName("http://sample.staxer.org/", "attBase64Binary");

    @XmlElement(name = "elemString", namespace = "http://sample.staxer.org/")
    private String elemString;

    @XmlElement(name = "elemInteger", namespace = "http://sample.staxer.org/")
    private Integer elemInteger;

    @XmlElement(name = "elemCharacter", namespace = "http://sample.staxer.org/")
    private Integer elemCharacter;

    @XmlElement(name = "elemFloat", namespace = "http://sample.staxer.org/")
    private Float elemFloat;

    @XmlElement(name = "elemDouble", namespace = "http://sample.staxer.org/")
    private Double elemDouble;

    @XmlElement(name = "elemDecimal", namespace = "http://sample.staxer.org/")
    private BigDecimal elemDecimal;

    @XmlElement(name = "elemDateTime", namespace = "http://sample.staxer.org/")
    @XmlSchemaType(name = "dateTime")
    private Date elemDateTime;

    @XmlElement(name = "elemBoolean", namespace = "http://sample.staxer.org/")
    private Boolean elemBoolean;

    @XmlElement(name = "elemBase64Binary", namespace = "http://sample.staxer.org/")
    private byte[] elemBase64Binary;

    @XmlElement(name = "lstString", namespace = "http://sample.staxer.org/")
    private ArrayList<String> lstString = new ArrayList<String>();

    @XmlElement(name = "lstInteger", namespace = "http://sample.staxer.org/")
    private ArrayList<Integer> lstInteger = new ArrayList<Integer>();

    @XmlElement(name = "lstCharacter", namespace = "http://sample.staxer.org/")
    private ArrayList<Integer> lstCharacter = new ArrayList<Integer>();

    @XmlElement(name = "lstFloat", namespace = "http://sample.staxer.org/")
    private ArrayList<Float> lstFloat = new ArrayList<Float>();

    @XmlElement(name = "lstDouble", namespace = "http://sample.staxer.org/")
    private ArrayList<Double> lstDouble = new ArrayList<Double>();

    @XmlElement(name = "lstDecimal", namespace = "http://sample.staxer.org/")
    private ArrayList<BigDecimal> lstDecimal = new ArrayList<BigDecimal>();

    @XmlElement(name = "lstDateTime", namespace = "http://sample.staxer.org/")
    @XmlSchemaType(name = "dateTime")
    private ArrayList<Date> lstDateTime = new ArrayList<Date>();

    @XmlElement(name = "lstBoolean", namespace = "http://sample.staxer.org/")
    private ArrayList<Boolean> lstBoolean = new ArrayList<Boolean>();

    @XmlElement(name = "lstBase64Binary", namespace = "http://sample.staxer.org/")
    private ArrayList<byte[]> lstBase64Binary = new ArrayList<byte[]>();

    @XmlAttribute(name = "attString", namespace = "http://sample.staxer.org/")
    private String attString;

    @XmlAttribute(name = "attInteger", namespace = "http://sample.staxer.org/")
    private Integer attInteger;

    @XmlAttribute(name = "attCharacter", namespace = "http://sample.staxer.org/")
    private Integer attCharacter;

    @XmlAttribute(name = "attFloat", namespace = "http://sample.staxer.org/")
    private Float attFloat;

    @XmlAttribute(name = "attDouble", namespace = "http://sample.staxer.org/")
    private Double attDouble;

    @XmlAttribute(name = "attDecimal", namespace = "http://sample.staxer.org/")
    private BigDecimal attDecimal;

    @XmlAttribute(name = "attDateTime", namespace = "http://sample.staxer.org/")
    @XmlSchemaType(name = "dateTime")
    ...
    @XmlAttribute(name = "attBase64Binary", namespace = "http://sample.staxer.org/")
