package org.staxer.util.staxer;

import org.staxer.util.staxer.domain.*;
import org.staxer.util.ResourceUtils;
import org.staxer.util.StringUtils;
import org.staxer.util.file.FileUtils;
import org.staxer.util.xml.StaxerXmlStreamReader;
import org.staxer.util.xml.XmlConstants;
...
import static org.staxer.util.StringUtils.capitalize2;
import static org.staxer.util.xml.XmlConstants.NAMESPACE_URI_XSD;
...
public class StaxerUtils {
    ...
    static {
        ...
        javaXsdType.getImports().add("org.staxer.util.NumberUtils");
        ...
        javaXsdType.getImports().add("org.staxer.util.StringUtils");
        ...
        javaXsdType.getImports().add("org.staxer.util.date.DateTimeUtils");
    ...
    public static void createJavaWebService(
        ...
        if (createClientService || createServerService) {
            ...
            if (createClientService) {
                ...
                writer.append(";\n\n");
                writer.append("import org.staxer.util.staxer.client.HttpWsClient;\n");
                writer.append("import org.staxer.util.staxer.client.WsClientException;\n");
                writer.append("import org.staxer.util.staxer.client.WsRequestHeader;\n");
                writer.append("import org.staxer.util.xml.XmlName;\n");
            ...
            if (createServerService) {
                ...
                writer.append(";\n");
                writer.append("\n");
                writer.append("import org.staxer.util.staxer.server.ServerServiceWs;\n");
                writer.append("import org.staxer.util.staxer.server.WsMessage;\n");
                writer.append("import org.staxer.util.http.helper.ReadHttpParameters;\n");
                writer.append("import org.staxer.util.xml.StaxerReadXml;\n");
                writer.append("import org.staxer.util.xml.XmlName;\n");
                writer.append("import ");
    ...
    private static Set<XmlName> createXsdBeansPrivate(
        ...
        xsdAnyComplexType.setJavaPackage("org.staxer.util.xml");
        ...
        for (XmlSchemaType xmlSchemaType : webServiceTypesMap.values()) {
            if (!xmlSchemaType.isComplexType()) {
                ...
                imports.add("org.staxer.util.xml.StaxerXmlStreamReader");
                imports.add("org.staxer.util.xml.StaxerXmlStreamWriter");
                imports.add("org.staxer.util.props.XmlNameMapProperties");
                imports.add("org.staxer.util.xml.StaxerXmlStreamException");
                imports.add("org.staxer.util.xml.XmlName");
                imports.add("org.staxer.util.xml.element.ListStaxerXmlElement");
                        ...
                        if (elementField) {
                            ...
                            if (fieldXsdType != null) {
                                ...
                                if (enumField) {
                                    ...
                                    imports.add("org.staxer.util.xml.XmlUtils");
                ...
                if (superTypeJavaName == null) {
                    imports.add("org.staxer.util.xml.StaxerReadXml");
                    imports.add("org.staxer.util.xml.StaxerWriteXml");
                }

                if (httpRequestReadable) {
                    imports.add("org.staxer.util.http.helper.HttpRequestHelper");
                    imports.add("org.staxer.util.http.helper.ReadHttpParameters");
                }
