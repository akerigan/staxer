...
public class XmlConstants {
    ...
    public static final XmlName XML_NAME_XSD_TARGET_NAMESPACE = new XmlName("targetNamespace");
    public static final XmlName XML_NAME_XSD_BASE = new XmlName("base");
    public static final XmlName XML_NAME_XSD_MIN_LENGTH = new XmlName(NAMESPACE_URI_XSD, "minLength");
    public static final XmlName XML_NAME_XSD_MAX_LENGTH = new XmlName(NAMESPACE_URI_XSD, "maxLength");
    public static final XmlName XML_NAME_XSD_VALUE = new XmlName("value");
    ...
    public static final XmlName XML_NAME_XSI_ANY_TYPE = new XmlName(NAMESPACE_URI_XSD, "anyType");
