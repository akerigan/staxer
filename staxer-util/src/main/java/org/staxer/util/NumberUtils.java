...
public class NumberUtils {
    ...
    public static Long getLong(BigDecimal value) throws SQLException {
        if (value != null) {
    ...
    public static int toSimpleInteger(Integer i) {
        if (i != null) {
            return i;
        } else {
            return 0;
    ...
    public static long toSimpleLong(Long l) {
        if (l != null) {
            return l;
        } else {
            return 0;
    ...
    public static float toSimpleFloat(Float f) {
        if (f != null) {
            return f;
        } else {
            return 0f;
    ...
    public static int invertBit(int i, int bit) {
        return i ^ (1 << bit);
    }
